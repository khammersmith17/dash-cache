...
fn bench_insert_existing_key_full_lru_crate(c: &mut Criterion) {
    let mut group = c.benchmark_group("lru_crate_insert_existing_full");
...
criterion_group!(
    lru_crate_insert_existing_full,
    bench_insert_existing_key_full_lru_crate
);
criterion_group!(
