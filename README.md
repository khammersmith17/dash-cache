...
- **IndexedCacheShard** — unsafe, uses a contiguous slab (`Vec`) with `u32` index pointers for improved cache locality
...
| cap    | LruCache | lru crate | CacheShard | IndexedCacheShard |
|--------|----------|-----------|------------|-------------------|
...
| n      | lru crate | CacheShard | IndexedCacheShard |
|--------|-----------|------------|-------------------|
...
| n      | CacheShard  | IndexedCacheShard |
|--------|-------------|-------------------|
...
| cap   | lru crate | CacheShard | IndexedCacheShard |
|-------|-----------|------------|-------------------|
